...
!        REAL*8  VAP,QBP,SBP,GLP
        REAL*8  xVpi,xSpi
C***********************************************************************
       pz = 2.D0                ! pion LMET BOOST MOMENTUM
...
!       Lq = 0.0892D0      ! COVARIANT CUTOFF (FOR PION)     
       ...
       Lq = 0.21D0      ! FOR REFEREE RESPONSE
...
!  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .
        OPEN (11,FILE='DATA/fpi_pz=1GeV.dat',
!        OPEN (11,FILE='DATA/fN_pz=5GeV.dat',
     &                           STATUS='UNKNOWN', FORM='FORMATTED')
          DO ix=1,nx
          WRITE (11,*) xpt(ix), xpt(ix)*pi(ix)/pi0, xpt(ix)*piq(ix)/pi0
        ENDDO
        CLOSE (11)
!
        OPEN (12,FILE='DATA/fpi_ratio_pz=1GeV.dat',
!        OPEN (11,FILE='DATA/fN_ratio_pz=5GeV.dat',
     &                           STATUS='UNKNOWN', FORM='FORMATTED')
          DO ix=1,nx
          WRITE (12,*) xpt(ix), disc(ix)
        ENDDO
        CLOSE (12)
!
!        OPEN (13,FILE='DATA/GRSpi_mu2=1.dat',
!        OPEN (13,FILE='DATA/GRSpi_mu2=1_mono.dat',
        OPEN (13,FILE='DATA/GRVpi_mu2=025.dat',
     &                           STATUS='UNKNOWN', FORM='FORMATTED')
          DO ix=1,nx
!          WRITE (13,*) xpt(ix), GRSv(ix), pi_FIT(ix)
          WRITE (13,*) xpt(ix), GRSv(ix)
        ENDDO
        CLOSE (13)
